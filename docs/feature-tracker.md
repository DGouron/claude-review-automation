...
| Setup Wizard Dashboard (Jarvis HUD) | [184-setup-wizard-dashboard-jarvis](specs/184-setup-wizard-dashboard-jarvis.md) — [plan A](plans/184-setup-wizard-dashboard-jarvis.plan.md) — [plan B](plans/184-setup-wizard-dashboard-jarvis-iter-B.plan.md) — reports: [A](reports/184-setup-wizard-dashboard-jarvis.report.md) [B1](reports/184-setup-wizard-dashboard-jarvis-iter-B1.report.md) | A + B1 done; B2 (forms) pending | 2026-05-28 |
