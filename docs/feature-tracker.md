...
| Block approval below quality threshold with comment-based bypass | [180-quality-threshold-block-approval](specs/180-quality-threshold-block-approval.md) — [plan](plans/180-quality-threshold-block-approval.plan.md) — [report](reports/180-quality-threshold-block-approval.report.md) | implementing (iter A done, B+C pending) | 2026-05-26 |
